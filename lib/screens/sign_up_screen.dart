...
class _SignUpScreenState extends State<SignUpScreen>
  ...
  // ✅ CORRECTION : Future<void> + await authService.signUp
        ...
        children: [
          const Positioned.fill(
            child: Image(
              ...
              fit: BoxFit.cover,
              opacity: AlwaysStoppedAnimation(0.18),
            ),
          ),
          Positioned.fill(
            child: Container(
                        ...
                        Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              _buildLabel("Nom complet", subColor),
                              ...
                              _buildLabel("Rôle", subColor),
                              const SizedBox(height: 8),
                              _buildRoleSelector(textColor, subColor),
                              const SizedBox(height: 14),
                              ...
                              _buildLabel("Confirmer le mot de passe", subColor),
                              const SizedBox(height: 6),
                              _buildTextField(
  ...
  Widget _buildRoleSelector(Color textColor, Color subColor) {
    return Row(
      children: [
        _roleOption(
          role: UserRole.owner,
        ...
        child: AnimatedContainer(
          ...
          decoration: BoxDecoration(
            color: isSelected
                ...
                : AppColors.card2.withOpacity(0.5),
            borderRadius: BorderRadius.circular(12),
            border: Border.all(
              color: isSelected
                  ? AppColors.redAlert.withOpacity(0.7)
                  : AppColors.subText.withOpacity(0.2),
          ...
          child: Column(
            children: [
              Icon(icon,
                  color: isSelected ? AppColors.redAlert : subColor, size: 22),
              const SizedBox(height: 6),
              Text(
                label,
                style: TextStyle(
                  color: isSelected ? AppColors.redAlert : textColor,
              ...
              Text(
                subtitle,
                style: TextStyle(color: subColor.withOpacity(0.7), fontSize: 10),
              ),
            ],
          ),
        ),
